...
{
    public class PullImagesFromAll : IBulkJob
    {
        private readonly IPullImagesFromAllProcessor[] processors;
        private readonly ILogger log;
        private Task? task;
        private CancellationTokenSource cancelToken = new();

        public PullImagesFromAll(IEnumerable<IPullImagesFromAllProcessor> processors, ILogger<PullImagesFromAll> log)
        {
